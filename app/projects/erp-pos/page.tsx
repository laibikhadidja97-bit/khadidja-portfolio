            ...
            <div className="glass overflow-hidden rounded-3xl">
              <div className="relative flex flex-col items-start gap-6 p-8 sm:flex-row sm:items-center sm:p-10">
                ...
                <div>
                  ...
                  <p className="mt-1 text-slate-400">{erpShowcase.tagline}</p>
                </div>
              </div>
            </div>
          </Reveal>
            ...
            <div className="space-y-5">
              ...
              <Reveal delay={0.05}>
                <div className="glass rounded-2xl p-6 text-sm text-slate-400">
                  <p className="font-medium text-slate-200">Private product</p>
                  <p className="mt-1.5 leading-relaxed">
                    This is a client product shown for preview only. The source
                ...
                <div className="glass flex flex-col items-center justify-center rounded-2xl border-dashed p-12 text-center">
                  ...
                  <p className="mt-1 max-w-md text-sm text-slate-500">
                    ...
                    <code className="rounded bg-white/5 px-1.5 py-0.5 text-slate-300">
                      public/screenshots/erp-pos/
                    </code>{" "}
                    and list them in{" "}
                    <code className="rounded bg-white/5 px-1.5 py-0.5 text-slate-300">
                      erpScreenshots
                    </code>{" "}
                    inside <code className="text-slate-300">lib/data.ts</code>.
                  </p>
                </div>
              </Reveal>
            )}
